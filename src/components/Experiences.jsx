  ...
  return (
    <div className="w-full bg-white py-6 px-4">
      <div className="max-w-[1000px] mx-auto grid md:grid-cols-2">
        <img className="w-[350px] mx-auto my-5" src="https://static.wixstatic.com/media/62eb01_d74e3850a7ab4a53a686c6154766c5c2~mv2.png/v1/fill/w_418,h_325,al_c,lg_1,q_85,enc_auto/Illustration%201.png" alt="/" />
        ...
        <h1 className="w-[350px] mx-auto my-5 md:text-4xl sm:text-3xl text-2xl font-bold py-3">We share our ideas, knowhow and experiences</h1>
        <div className="flex flex-col justify-center">
